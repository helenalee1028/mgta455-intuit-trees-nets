...
```
Thus we can see that using 100 n.trees is better than 200 trees, so for the final model we choose to use 100 n.trees to train the data to prevent overfitting.
So the best model we select has the highest profit of 460358.593170667 on the test set. It has the hyperparameters of 3 interaction depth, shrinkage of 0.1.
